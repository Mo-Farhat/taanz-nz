  ...
  return (
    <footer className="text-white bg-gray-900">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          ...
          >
            ...
            <p className="text-gray-400 font-montserrat text-sm">
              TAANZ Outsourcing - Your trusted partner in financial excellence across Australia and New Zealand.
            </p>
          </motion.div>
          ...
          <motion.div 
            ...
            variants={itemVariants}
          >
            <h3 className="text-white text-lg font-bold font-montserrat">Quick Links</h3>
          ...
          <motion.div 
            ...
            variants={itemVariants}
          >
            <h3 className="text-white text-lg font-bold font-montserrat">Contact Us</h3>
              ...
              {[
                {
                  ...
                  text: "123 Business Street, Sydney NSW 2000, Australia"
                },
                {
                  icon: (
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                >
                  ...
                  <span className="group-hover:text-blue-500 transition-colors duration-300">{item.text}</span>
                </motion.li>
              ))}
            </ul>
          </motion.div>
          ...
          <motion.div 
            ...
            variants={itemVariants}
          >
            <h3 className="text-white text-lg font-bold font-montserrat">Connect With Us</h3>
        ...
        >
          <p className="text-gray-400 font-montserrat text-sm">
            © 2024 TAANZ Outsourcing. All rights reserved.
          </p>
        </motion.div>
      </div>
    </footer>
